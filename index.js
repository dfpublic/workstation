        ...
        },
        {
            ...
            submenu: [
                ...
                },
                {
                    ...
                    click: () => {
                        raise_event(win, 'reload-all-modules');
                    },
                },

                {
                    ...
                    click: () => {
                        raise_event(win, 'switch-next-module');
                    },
                },

                {
                    ...
                    click: () => {
                        raise_event(win, 'switch-previous-module');
                    },
                },
            ],
        },
...
function init(win) {
    ...
    ipcMain.on('main_get_configs', () => {
        ...
        raise_event(win, 'ui_configs_received', {
            config,
            module_data,
            default_module,
            debug,
